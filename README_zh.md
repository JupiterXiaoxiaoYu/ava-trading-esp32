...
| Screen Contracts | 框架 screen payload schema 和 portable LVGL 目标 | `ava-devicekit/schemas/`, `ava-devicekit/shared_ui/`，legacy 参考在 `shared/ave_screens/` |
...
| 确认 legacy 能力取舍 | [`ava-devicekit/docs/xiaozhi-capability-inventory.md`](ava-devicekit/docs/xiaozhi-capability-inventory.md) |
...
语音 + 物理输入
  ...
  -> ScreenPayload / ActionDraft contract
       -> 当前 LVGL 参考在 shared/ave_screens
