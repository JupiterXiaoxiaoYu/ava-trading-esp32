...
| [`../ava-devicekit/docs/solana-reference-repos-review.md`](../ava-devicekit/docs/solana-reference-repos-review.md) | Solana ESP32 / DePIN / payment / signer reference review and DeviceKit mapping |
