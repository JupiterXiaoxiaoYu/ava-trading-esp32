...
| [`../ava-devicekit/docs/legacy-capability-inventory.md`](../ava-devicekit/docs/legacy-capability-inventory.md) | Decision matrix for which legacy capabilities to keep, replace, drop, or defer |
