...
| App-level provider/service overrides | Framework admin/API | Complete MVP | `/admin/apps/{app_id}/runtime/providers`, `/admin/apps/{app_id}/runtime/config`, and `/admin/apps/{app_id}/developer/services` store app-scoped provider/service config; active-app overrides apply immediately. |
