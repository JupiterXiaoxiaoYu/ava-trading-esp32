...
#define AVE_WATCH_STAR_ICON "\xef\x80\x85"
...
#if defined(LV_SIMULATOR)
    /* Simulator fallback fonts may miss Unicode star glyphs, so use ASCII. */
    lv_obj_set_style_text_font(s_lbl_watch_star, &lv_font_montserrat_14, 0);
