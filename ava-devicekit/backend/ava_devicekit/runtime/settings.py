        ...
        return {
            ...
            "providers": {
                "asr": {
                    ...
                    "class": self.asr_class,
                    "model": self.asr_model,
                    "base_url": self.asr_base_url,
                    "api_key_env": self.asr_api_key_env,
                    "language": self.asr_language,
                    "sample_rate": self.asr_sample_rate,
                    "options": _sanitize_options(self.asr_options),
                },
                "llm": {
                    "provider": self.llm_provider,
                    "class": self.llm_class,
                    "model": self.llm_model,
                    "base_url": self.llm_base_url,
                    "api_key_env": self.llm_api_key_env,
                    "timeout_sec": self.llm_timeout_sec,
                    "options": _sanitize_options(self.llm_options),
                },
                "tts": {
                    "provider": self.tts_provider,
                    "class": self.tts_class,
                    ...
                    "options": _sanitize_options(self.tts_options),
                },
            },
