...
<main class="shell">
  <section class="story">
    ...
    <div class="steps" aria-label="Activation steps">
      <div class="step"><b>1</b><span>Connect wallet.</span></div>
      <div class="step"><b>2</b><span>Sign the Ava login challenge. No transaction is sent.</span></div>
      <div class="step"><b>3</b><span>Enter the activation code and confirm the device.</span></div>
    </div>
  </section>
  <aside class="panel">
    <section class="card">
